        ...
        <div className={styles.header}>
          <div className={styles.logo}>
            <svg viewBox="0 0 60 60" fill="none" className={styles.logoSvg}>
              ...
              <text x="30" y="40" textAnchor="middle" fill="white" fontSize="28" fontWeight="bold">ĐH</text>
            </svg>
          </div>
          <h1 className="text-lg font-bold text-gray-800">
            HỆ THỐNG QUẢN LÝ ĐỒ ÁN
          </h1>
          <p className="text-sm text-gray-500">Trường Đại học Sài Gòn — Khoa Công nghệ Thông tin</p>
        </div>

        <form onSubmit={handleSubmit} className="rounded-xl bg-white p-6 shadow-lg ring-1 ring-gray-200/60">
          <h2 className="mb-1 text-base font-semibold text-gray-800">Đăng ký tài khoản</h2>
          <p className="mb-5 text-xs text-gray-400">Vui lòng điền thông tin để đăng ký hệ thống</p>
          ...
          <div className="space-y-4">
            ...
            <Field
              ...
              error={errors.email}
              placeholder="student@sgu.edu.vn"
            />
            <Field
              label="Mật khẩu"
              type="password"
          ...
          <p className="mt-4 text-center text-xs text-gray-400">
            Đã có tài khoản?{' '}
            <span className="cursor-pointer text-blue-600 hover:underline">Đăng nhập</span>
          </p>
        </form>
